...
export default function Home() {
  const [todos, setTodos] = useState<ToDoItem[]>([{ title: "Example", description: "This is an example", completed: false }]);

  return (
    <div className="max-w-screen-md mx-auto p-4 space-y-4">
      <h1 className="text-xl fond-bold">To-Do List</h1>
  ...
  return (
    <li className="w-full items-center flex gap-2 border rounded p-2">
      ...
      <div className="ml-auto">
        <button className="text-red-500" type="button" onClick={() => onRemove()}>Remove</button>
      </div>
    </li>
  )
}